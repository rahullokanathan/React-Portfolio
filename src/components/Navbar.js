    ...
    <nav class="navbar navbar-expand-lg">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class=" btn btn-outline-success text-success" href={"https://drive.google.com/file/d/1Eoug3PTN8-3re60t4qxR6f84dEsKJJTt/view"} target='_blank' style={{ borderRadius: "0px" }}>RESUME</a>
          </li>
        </ul>
      </div>
    </nav>
