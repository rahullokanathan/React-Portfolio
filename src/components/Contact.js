...
export const Contact = () => {
    return (
        ...
        <div className='col-md-6 mx-auto' id="contactus">
            ...
            <a href='https://github.com/rahullokanathan' target='_blank' style={{color:"black"}} >
            <i class="fab fa-github" ></i>
            </a>
            <a href='https://www.linkedin.com/in/rahul-lokanathan-27a308126/' target='_blank'>
            <i class="fab fa-linkedin-in" style={{color:"#0e76a8"}}></i>
            </a>
            <a href='https://wa.me/+919962629173' target='_blank'>
